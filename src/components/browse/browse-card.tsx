...
export function VerticalBrowseCard({
  ...
  return (
    <motion.button
      ...
      className="group relative w-[160px] shrink-0 text-left md:w-[200px]"
    >
      <div className="relative aspect-[9/16] overflow-hidden bg-chalk shadow-md transition group-hover:shadow-2xl">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-ink/0 opacity-0 transition group-hover:bg-ink/30 group-hover:opacity-100">
          <span className="flex h-10 w-10 items-center justify-center rounded-full bg-paper text-ink shadow-2xl">
