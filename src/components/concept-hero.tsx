...
export function ConceptHero() {
  return (
    <section className="relative px-5 pb-8 pt-20 md:px-10 md:pb-14 md:pt-28">
      <div className="mx-auto w-full max-w-[1800px]">
        ...
        <motion.h1
          ...
          className="mt-3 font-display font-black leading-[0.92] tracking-[-0.04em] text-[clamp(32px,7vw,108px)] md:leading-[0.88]"
        >
        ...
        <motion.div
          ...
          className="mt-5 grid grid-cols-12 gap-x-4 gap-y-2 md:mt-6"
        >
          <p className="col-span-12 font-mono text-[10px] uppercase tracking-[0.28em] text-smoke md:col-span-3">
            ¶  Le principe
          </p>
          <p className="col-span-12 max-w-2xl font-display leading-snug text-[clamp(16px,1.6vw,20px)] md:col-span-9">
